...
<a href="index_path.php" style="text-decoration:none; color: white; font-size: 25px;">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;


<a href="index1_path.php" style="text-decoration:none; color: white; font-size: 25px;">Upload</a>&nbsp;&nbsp;&nbsp;&nbsp;

<a href="index_path.php?logout='1'" style="text-decoration:none; color: red; float: right; font-size: 20px; " >Logout</a>
